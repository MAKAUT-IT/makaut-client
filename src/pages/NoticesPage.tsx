...
export default function NoticesPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            const payload = { ...formData, type: 'notice' };
            if (editingNotice) {
                await api.put(`/announcements/${editingNotice._id}`, payload);
            } else {
                                    ...
                                    <div className="flex items-start justify-between">
                                        ...
                                        {isAdmin && (
                                            <div className="flex items-center gap-2 ml-4">
                                                <Button variant="outline" size="sm" onClick={() => handleOpenEditModal(notice)}>
                                                    <Edit className="h-4 w-4" />
                                                </Button>
                                                <Button variant="destructive" size="sm" onClick={() => handleOpenDeleteModal(notice)}>
                        ...
                        <form onSubmit={handleSubmit} className="p-4 space-y-4">
                            ...
                            <div className="flex justify-end gap-2 pt-4">
                                ...
                                <Button type="submit" disabled={submitting}>
                                    {submitting ? <Loader2 className="h-4 w-4 animate-spin" /> : editingNotice ? 'Update' : 'Create'}
                                </Button>
                            </div>
                        </form>
                    </div>
